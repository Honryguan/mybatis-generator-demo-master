...
public class BasePlugin extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        boolean needSwagger = isTrue(properties.getProperty("needSwagger"));
...
//        field.addJavaDocLine(" */");
    ...
    public static void classAnnotation(TopLevelClass topLevelClass, String explain) {
        ...
        topLevelClass.addJavaDocLine("* @author honry.guan");
        topLevelClass.addJavaDocLine("* @created Time: " + dateFormat.format(new Date()));
        topLevelClass.addJavaDocLine("*/");
        // 生成注释结束
    }
    ...
    public static void interfazeAnnotation(Interface interfaze, String explain) {
        ...
        interfaze.addJavaDocLine("* @author honry.guan");
        interfaze.addJavaDocLine("* @created Time: " + dateFormat.format(new Date()));
        interfaze.addJavaDocLine("*/");
        // 生成注释结束
    }
    ...
    public void generateControllerFile(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) throws IOException, TemplateException {
        ...
        if (packageController != null) {
            ...
            String packageBean = properties.getProperty("bean");
            ...
            dataMap.put("package_bean", packageBean);
